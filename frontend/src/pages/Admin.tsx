                    ...
                    <Dialog open={Boolean(selectedWorklog)} onOpenChange={(v) => !v && setSelectedWorklog(null)}>
                        <DialogContent className="glass-card max-w-lg">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Full details for this worklog entry.
                                </DialogDescription>
                            </DialogHeader>
                            {selectedWorklog && (
                                <div className="space-y-4 py-1">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <div className="rounded-lg bg-muted/40 p-3">
                                            ...
                                            <p className="text-sm font-medium">
                                                {new Date(selectedWorklog.date).toLocaleDateString("en-IN", { day: "2-digit", month: "short", year: "numeric" })}
                                            </p>
                                        </div>
                                        <div className="rounded-lg bg-muted/40 p-3">
                                        ...
                                        <div className="rounded-lg bg-muted/40 p-3">
                                            ...
                                            <StatusBadge
                                                status={selectedWorklog.status === "submitted" ? "success" : "pending"}
                                                label={selectedWorklog.status === "submitted" ? "Submitted" : "Draft"}
                                            />
                                        </div>
                                        <div className="rounded-lg bg-muted/40 p-3">
                                            <p className="text-xs text-muted-foreground mb-1">Tasks</p>
                                            <p className="text-sm font-medium">{selectedWorklog.tasks?.length ?? 0} task{selectedWorklog.tasks?.length !== 1 ? "s" : ""}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="border-t border-border pt-3 grid grid-cols-2 gap-2 text-xs text-muted-foreground">
                                        <div>
                                            <span className="block font-medium text-foreground/70">Created</span>
                                            {selectedWorklog.createdAt
                                                ? new Date(selectedWorklog.createdAt).toLocaleString("en-IN", { day: "2-digit", month: "short", year: "numeric", hour: "2-digit", minute: "2-digit" })
                                                : "—"}
                                        </div>
                                        <div>
                                            <span className="block font-medium text-foreground/70">
                                                {selectedWorklog.status === "submitted" ? "Submitted" : "Last Updated"}
                                            </span>
                                            {selectedWorklog.updatedAt
                                                ? new Date(selectedWorklog.updatedAt).toLocaleString("en-IN", { day: "2-digit", month: "short", year: "numeric", hour: "2-digit", minute: "2-digit" })
                                                : "—"}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <TableBody>
                                    {reportsLoading ? (
                                        ...
                                        reportsData.filter(r =>
                                            searchQuery ? (r.userName?.toLowerCase().includes(searchQuery.toLowerCase()) || r.period.toLowerCase().includes(searchQuery.toLowerCase())) : true
                                        ).map((r: any) => (
                                            <TableRow key={r.id}>
                                                ...
                                                <TableCell>
                                                    <StatusBadge
                                                        status={r.type === 'weekly' ? 'pending' : 'warning'}
                                                        label={r.type}
                                                    />
                                                </TableCell>
                    ...
                    <GlassCard>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 mb-4">
                            <div className="relative flex-1">
                                <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                                <Input
                                    placeholder="Search by student name, ACE ID, or title..."
                                        ...
                                        blogPostsData
                                            ...
                                            .map((p: any) => (
                                                <TableRow key={p.id}>
                                                    ...
                                                    <TableCell>
                                                        <span className="capitalize text-xs font-medium px-2 py-0.5 rounded-full bg-primary/10 text-primary">
                                                            {p.platform}
                                                        </span>
                                                    </TableCell>
                                                    <TableCell className="max-w-[200px]">
                                                        <a
                                                            ...
                                                            target="_blank"
                                                            rel="noreferrer"
                                                            className="text-sm text-foreground hover:text-primary hover:underline line-clamp-1 flex items-center gap-1"
                                                        >
                                                            {p.title}
                                                        </a>
                                                    </TableCell>
                                                        ...
                                                        <span className={`text-sm font-semibold ${p.averageScore > 0 ? "text-amber-400" : "text-muted-foreground"}`}>
                                                            ...
                                                            {p.scores?.length > 0 && (
                                                                <span className="text-xs font-normal text-muted-foreground ml-1">
                                                                    ({p.scores.length} {p.scores.length === 1 ? "score" : "scores"})
                                                                </span>
                                                            )}
                                                        </span>
                                                    </TableCell>
                                                        ...
                                                        <div className="flex justify-end gap-2">
                                                            ...
                                                            <Button
                                                                ...
                                                                onClick={() => {
                                                                    setScoringPost(p);
                                                                    setScoreInput(
                                                                        p.scores?.find((s: any) => s.adminId === "me")?.score?.toString() ?? ""
                                                                    );
                                                                }}
                                                            >
                                                                Score
                    ...
                    <Dialog open={Boolean(scoringPost)} onOpenChange={(v) => { if (!v) { setScoringPost(null); setScoreInput(""); } }}>
                        <DialogContent className="glass-card sm:max-w-md">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Give a score from 0 to 10. Multiple admins can score individually; the average is shown to students.
                                </DialogDescription>
                            </DialogHeader>
                            {scoringPost && (
                                <div className="space-y-4 py-2">
                                    ...
                                    <div className="rounded-lg bg-muted/40 p-3 space-y-1.5">
                                        ...
                                        <a href={scoringPost.link} target="_blank" rel="noreferrer"
                                            className="text-sm font-semibold text-foreground hover:text-primary hover:underline flex items-center gap-1">
                                            {scoringPost.title}
                                        </a>
                            ...
                            <DialogFooter>
                                ...
                                <Button
                                    disabled={isScoring || scoreInput === "" || Number(scoreInput) < 0 || Number(scoreInput) > 10}
                                    onClick={async () => {
                                        ...
                                        try {
                                            ...
                                            toast.error(err?.data?.message || "Failed to submit score");
                                        }
                                    }}
